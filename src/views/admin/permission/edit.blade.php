    ...
    <div class="layui-card-body">
        <div class="layui-form" lay-filter="permission-form" id="permission-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" value="{{ $permission->name }}" placeholder="请输入菜单名称" autocomplete="off" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="url" lay-verify="title" autocomplete="off" value="{{ $permission->url }}" placeholder="请输入菜单链接" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input placeholder="请输入或选择图标" name="icon" value='{{ $permission->icon }}' class="layui-input">
                    </div>
                    <span style="padding:0 12px;min-width:45px" class='layui-btn layui-btn-primary'>
                    <i style="font-size:1.2em;margin:0" class='{{ $permission->icon }}' id="icon-wrap"></i>
                </span>
